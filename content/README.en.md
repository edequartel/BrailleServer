...
## Gebruik van de brailleleesregel
...
### Letters en woorden
Je oefent letters en woorden door ze te horen en op de leesregel te volgen.

### Verhalen
Een verhaal wordt voorgelezen. Je kunt pauzeren, verder en terug.

### Oefeningen
Er zijn activiteiten zoals:
- leessnelheid meten  
- dictee  
- vragen beantwoorden over een tekst  
- auditieve feedback tijdens het oefenen
...
- de leerling krijgt keuzevrijheid en controle  
- fouten maken hoort erbij en levert informatie op  
...
Geluiden worden automatisch geladen.  
Als audio niet werkt, controleer of:
- het volume aan staat  
- de browser audio mag afspelen  
- de pagina volledig geladen is

## Veelvoorkomende problemen

### Geen verbinding met de leesregel
- Controleer of BrailleBridge draait  
- Sluit de leesregel opnieuw aan  
- Herstart de browser

### Geen audio
- Controleer het volume  
- Geef de browser toestemming voor audio  
- Herlaad de pagina

### Geen reactie op knoppen
- Controleer USB  
- Kijk of BrailleBridge meldingen toont  
